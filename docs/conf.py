# -*- coding: utf-8 -*-
#
# Metrocar documentation build configuration file, created by
...
project = u'Metrocar'
copyright = u'2012, CTU FEL & FIT Collective'
...
latex_documents = [
  ('index', 'Metrocar.tex', u'Metrocar Documentation',
   u'FCTU FEL \\& FIT Collective', 'manual'),
]
...
man_pages = [
    ('index', 'metrocar', u'Metrocar Documentation',
     [u'FCTU FEL & FIT Collective'], 1)
]
...
texinfo_documents = [
  ('index', 'Metrocar', u'Metrocar Documentation',
   u'FCTU FEL & FIT Collective', 'Metrocar', 'One line description of project.',
   'Miscellaneous'),
]
