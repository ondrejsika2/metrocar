...
SECRET_KEY = '9gy9@j5&amp;a0bm6)ch(pq4+194*rgrwxsen!hfiueb3a+=-0@*gb'
...
INSTALLED_APPS = (
    ...
    'django.contrib.gis',
    'testing_project.my_app',
)


GEOTRACK = {
    'BACKEND': 'geotrack.backends.geodjango',
    'MODEL': 'my_app.GeoLogEntry',
}

from os.path import join, dirname, abspath

# TEST_RUNNER = 'django_pytest.test_runner.TestRunner'
TEST_RUNNER = 'testing_project.testrunner.DiscoveryDjangoTestSuiteRunner'
...
try:
    ...
    import sys
    print >> sys.stderr, ('Please configure a Spatial database to test on in '
        'settings_local.py')
