...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ticket.which_car'
        db.add_column(u'helpdesk_ticket', 'which_car',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['cars.Car'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ticket.which_car'
        db.delete_column(u'helpdesk_ticket', 'which_car_id')
