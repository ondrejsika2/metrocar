...
# Monkey Patch - patch for Options, REQUIRED FOR DJANGO ver. < 1.6
# description (https://code.djangoproject.com/ticket/20853)
# solution (https://github.com/burke-software/django-report-builder/issues/114)
