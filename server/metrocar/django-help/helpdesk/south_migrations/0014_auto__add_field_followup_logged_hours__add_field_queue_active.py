...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FollowUp.logged_hours'
        db.add_column(u'helpdesk_followup', 'logged_hours',
                      self.gf('django.db.models.fields.FloatField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'Queue.active'
        db.add_column(u'helpdesk_queue', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FollowUp.logged_hours'
        db.delete_column(u'helpdesk_followup', 'logged_hours')

        # Deleting field 'Queue.active'
        db.delete_column(u'helpdesk_queue', 'active')
    ...
    models = {
        ...
        u'helpdesk.followup': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'logged_hours': ('django.db.models.fields.FloatField', [], {'default': '0', 'blank': 'True'}),
