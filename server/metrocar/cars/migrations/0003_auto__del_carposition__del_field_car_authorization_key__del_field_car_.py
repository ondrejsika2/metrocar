...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Car.authorization_key'
        db.delete_column('cars_car', 'authorization_key')

        # Deleting field 'Car.last_echo'
        db.delete_column('cars_car', 'last_echo')

        # Deleting field 'Car.imei'
        db.delete_column('cars_car', 'imei')

        # Deleting field 'Car.mobile_number'
        db.delete_column('cars_car', 'mobile_number')

        # Deleting field 'Journey.path'
        db.delete_column('cars_journey', 'path')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Car.authorization_key'
        db.add_column('cars_car', 'authorization_key',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Car.last_echo'
        db.add_column('cars_car', 'last_echo',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Car.imei'
        db.add_column('cars_car', 'imei',
                      self.gf('django.db.models.fields.CharField')(unique=True, max_length=18, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Car.mobile_number'
        db.add_column('cars_car', 'mobile_number',
                      self.gf('metrocar.utils.fields.PhoneField')(max_length=14, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Journey.path'
        db.add_column('cars_journey', 'path',
                      self.gf('django.contrib.gis.db.models.fields.MultiLineStringField')(null=True, spatial_index=False, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'user_management.accountactivity': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 7, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
