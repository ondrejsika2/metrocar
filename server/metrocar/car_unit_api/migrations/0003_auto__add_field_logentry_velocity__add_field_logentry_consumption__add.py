...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LogEntry.velocity'
        db.add_column('car_unit_api_logentry', 'velocity',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LogEntry.consumption'
        db.add_column('car_unit_api_logentry', 'consumption',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LogEntry.fuel_remaining'
        db.add_column('car_unit_api_logentry', 'fuel_remaining',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LogEntry.velocity'
        db.delete_column('car_unit_api_logentry', 'velocity')

        # Deleting field 'LogEntry.consumption'
        db.delete_column('car_unit_api_logentry', 'consumption')

        # Deleting field 'LogEntry.fuel_remaining'
        db.delete_column('car_unit_api_logentry', 'fuel_remaining')
    ...
    models = {
        ...
        'car_unit_api.carunit': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'secret_key': ('django.db.models.fields.CharField', [], {'default': "'8&$qq7@pa-sr8so-n04s716p_8t=#nsp6w7xc34msveo%6eqf4'", 'max_length': '50'}),
        ...
        'car_unit_api.logentry': {
            ...
            'consumption': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'event': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '30', 'null': 'True', 'blank': 'True'}),
            'fuel_remaining': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'odometer': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '8', 'decimal_places': '2', 'blank': 'True'}),
            ...
            'velocity': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'})
        },
        'cars.car': {
