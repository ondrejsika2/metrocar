...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LogEntry.engine_rpm'
        db.add_column('car_unit_api_logentry', 'engine_rpm',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LogEntry.engine_rpm'
        db.delete_column('car_unit_api_logentry', 'engine_rpm')
    ...
    models = {
        ...
        'car_unit_api.carunit': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'secret_key': ('django.db.models.fields.CharField', [], {'default': "'!a39vvl1lu(^k%yz#%86rs!=9gy8#jhw=(y#(4q$$%x5+n0d=q'", 'max_length': '50'}),
