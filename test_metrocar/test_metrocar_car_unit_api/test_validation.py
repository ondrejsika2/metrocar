...
class TestValidUserId(django.test.TestCase ):
    ...
    def test_valid(self):
        self.assertEquals(valid_user_id(self.user.pk, 'field_name'), OK)
    ...
    def test_user_does_not_exist(self):
        ...
        self.assertFalse(valid)
        self.assertEquals(error, 'User with id "648167" does not exist')
