...
DATABASE_NAME = 'metrocar_cz'             # Or path to database file if using sqlite3.
DATABASE_USER = 'metrocar_cz'             # Not used with sqlite3.
...
LANGUAGE_CODE = 'cs'
LANG_CHOICES = (('CS', _('Czech')), ('EN', _('English')),)
