...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Subsidiary.max_account_balance'
        db.add_column('subsidiaries_subsidiary', 'max_account_balance',
                      self.gf('django.db.models.fields.DecimalField')(default='15000', max_digits=8, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Subsidiary.max_account_balance'
        db.delete_column('subsidiaries_subsidiary', 'max_account_balance')
