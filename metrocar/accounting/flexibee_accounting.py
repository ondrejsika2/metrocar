...
class FlexibeeManager(AccountingManager):
    ...
    def create_invoice(self, invoice):
        ...
        if invoice.status == 'PAID':
            ...
            if paid_ammout_sum != 0:
                ...
                it = {'kod': 'itemUhr', 'nazev': 'Jiz uhrazeno z vaseho konta', 'typSzbDphK': 'typSzbDph.dphZakl',
    ...
    def get_invoice(self, invoice):
        ...
        try:
            ...
            get_logger().error("Can't get invoice with id=" + str(invoice.id) + ". Complete error: " + str(e))
            return None
