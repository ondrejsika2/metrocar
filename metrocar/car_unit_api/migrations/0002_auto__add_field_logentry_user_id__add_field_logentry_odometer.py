...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LogEntry.user_id'
        db.add_column('car_unit_api_logentry', 'user_id',
                      self.gf('django.db.models.fields.IntegerField')(db_index=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'LogEntry.odometer'
        db.add_column('car_unit_api_logentry', 'odometer',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LogEntry.user_id'
        db.delete_column('car_unit_api_logentry', 'user_id')

        # Deleting field 'LogEntry.odometer'
        db.delete_column('car_unit_api_logentry', 'odometer')
    ...
    models = {
        ...
        'car_unit_api.carunit': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'secret_key': ('django.db.models.fields.CharField', [], {'default': "'$1p7=isd4#3u(&j^i(t+rks09^&@60!j0uql@b#^$b^+%1f%j!'", 'max_length': '50'}),
