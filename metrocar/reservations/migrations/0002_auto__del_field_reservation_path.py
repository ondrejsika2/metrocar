...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Reservation.path'
        db.delete_column('reservations_reservation', 'path')


    def backwards(self, orm):
        # Adding field 'Reservation.path'
        db.add_column('reservations_reservation', 'path',
                      self.gf('django.contrib.gis.db.models.fields.MultiLineStringField')(default=None, null=True, spatial_index=False, blank=True),
                      keep_default=False)
